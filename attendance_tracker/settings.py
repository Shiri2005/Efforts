...
SECRET_KEY = 'django-insecure-oe!($dz61s=q90pn+_4m-0ha#==fl#zhb&j9l!r5^m#2&f%6)n'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # Auth with JWT tokens
    ),
